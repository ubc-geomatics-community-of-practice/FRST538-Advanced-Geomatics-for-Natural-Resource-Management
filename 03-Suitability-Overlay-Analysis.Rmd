...
Once you have obtained Vessel_F, you will proceed to calculate **Vessel_Fmax**. The vessel suitability score is based on the sum of the 5 vessel uses which can have values of 0,1,2. So the maximum vessel score if every use type = 2 would be 10. The Vessel_Fmax value is 10. Then to get the suitability scores that go into the suitability equation you would divide the sum of the vessel uses for each polygon (ranging from 0-10) by 10. **Vessel_F**/**Vessel_Fmax** (or 10).
