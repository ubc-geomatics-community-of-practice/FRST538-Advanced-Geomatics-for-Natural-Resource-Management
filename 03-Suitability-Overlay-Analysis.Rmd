...
A biologically important area (BIA) identifies where cetaceans concentrate for specific behaviours. Download the data from Canvas and connect the geodatabase to your new Map.

You will need to extract the BIA for the humpback whales from the other species. 

**Step 2:** Add **Cetaceans_BIA** to your map in ArcGIS Pro.
