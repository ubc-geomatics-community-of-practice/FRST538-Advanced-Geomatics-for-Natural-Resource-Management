...
Navigate to where the data is saved and click ok. When you can find the data folder, drag-and-drop the **MKRF_UTM10S_2019_BAP.tif **  file into the map window. At this point, you should see an RGB satellite image of the Malcom Knapp Research Forest (Figure 1) if the mapview does not immediately pan to the image right click **MKRF_UTM10S_2019_BAP.tif ** in the Contents pane and press Zoom to Layer.
