...
-   A table with the ordinary least squares and geographically weighted regression results for the models. Include both Adjusted R^2^ and AIC.
...
-   Describe how to interpret standardized residuals, Adjusted R^2^ and AIC. Which model had better performance, OLS or GWR? Use the table of summary statistics and maps of the standardized residuals to support your answer.
...
-   Interpret one of your independent variables in the GWR using the R^2^ and Coefficient map. What spatial patterns do you see? What do you think could be influencing this relationship?
...
**Step 4:** Make some maps to explore your GWR results:

- Map **one** "Coefficient" for one of your independent variables for all dissemination areas
- Map the "Local R-Squared" for all dissemination areas
- Map the "Std Residual" for all dissemination areas

Reference these maps when you are explaining your results in your report.

**Step 5:** Answer the following questions in your report and refer to all the maps, tables, and figures you made in the previous steps:
