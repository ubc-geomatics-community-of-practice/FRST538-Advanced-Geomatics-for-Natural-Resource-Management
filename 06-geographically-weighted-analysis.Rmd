...
<input type="checkbox" unchecked> A table with the OLS and GWR results </input>

Lab report with the following specification:

<input type="checkbox" unchecked> A two-page report (PDF) outlining your results with at least one map </input>
...
## Task 1: Join Demographics data to the Dissemination Areas {.unnumbered}
...
## Task 2: Determine the distance from green spaces to Disssemination Areas {.unnumbered}
...
## Task 3: Detrmine the variables to include in your analysis {.unnumbered}

To conduct a GWR analysis, it is important to initially analyze our range of variables to determine which variables and combination of variables have the strongest relationship with our dependent variable, green spaces. To conduct the initial analysis, you will use a tool named ‘Exploratory Regression’, which is part of the Spatial Statistics Toolbox. Click [here](https://pro.arcgis.com/en/pro-app/tool-reference/spatial-statistics/exploratory-regression.htm) to learn more about the tool. 
...
```{r 06-select-twelve-demographic-variables, out.width= "35%", echo = FALSE, fig.align='center'}
    knitr::include_graphics("images/06-select-twelve-demographic-variables.png")
```
...
## Task 4: Determine the Overarching Relationship Between Green Spaces and your Variables {.unnumbered}
...
```{r 06-ols-six-variables-selected, out.width= "35%", echo = FALSE, fig.align='center'}
    knitr::include_graphics("images/06-ols-six-variables-selected.png")
```

------------------------------------------------------------------------

## Task 5: Conduct a Geographically Weighted Analysis {.unnumbered}
...
```{r 06-golden-search, out.width= "35%", echo = FALSE, fig.align='center'}
    knitr::include_graphics("images/06-golden-search.png")
```
...
```{r 06-relationship-between-variables, out.width= "50%", echo = FALSE, fig.align='center'}
    knitr::include_graphics("images/06-relationship-between-variables.png")
```
