...
-   Plan field data collection using GNSS 
...
**Step 1:** Open ArcGIS Pro and turn on an imagery basemap ("Map", "Basemap", and "Imagery"). Navigate to your proposed study area. You can do this by (a) dragging around your map, (b) putting coordinates into Go To XY, (c) typing in an address or park name into the Locate tool.
...
Using the top ribbon, select Share , then Export Map. A pane will pop up on the right-hand side of your screen. The file type is PDF, and make sure that it is saved somewhere you will be able to find it. Toward the bottom of the pane, make sure that the box under "PDF Settings" that says "Export georeference information" is selected. Then select "Export". This will be used when you are collecting data with Avenza.
