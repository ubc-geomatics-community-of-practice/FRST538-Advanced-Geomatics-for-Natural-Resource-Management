...
<input type="checkbox" unchecked> Screenshots of your Trimble GNSS Planning tool charts (your settings must be visible in all the screenshots):</input>
- Number of Satellites
- DOPs
- Iono Information
- Sky Plot

<input type="checkbox" unchecked> Map of the "True" and "Observed" points</input>

<input type="checkbox" unchecked> Table of accuracy and precision calculated values</input>
