...
To begin **Open** ArcGIS Pro and create a new Project called “Lab7_yourName” and save it in your lab 7 folder. Navigate to the Catalog and open the “LC08_L1TP_047026_20210529_2.tif” file in map view. This file is a raster layer stack representing 8 bands/channels of Landsat 8 OLI imagery acquired May 29th 2021; where each band corresponds to the table above in the Data description except band_8 = Cirrus. 
...
Select the Lab 7 Project folder as your “Output Location” and select **Next** at the bottom of the Image Classification Wizard pane. The “Training Samples Manager” should appear and you should see something similar to the image below. 
