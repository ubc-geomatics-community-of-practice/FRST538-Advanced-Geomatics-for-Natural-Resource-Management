...
```{r 01-spectral-reflectance-characteristics, out.width= "80%", echo = FALSE}
...
**Q2:** True/False: Soil and vegetation reflect roughly the same proportion of blue light.
...
```{r 01-reflectance-characteristics-unknown-features, out.width= "80%", echo = FALSE}
...
```{r 01-starting-arcgispro-prompt, out.width= "100%", echo = FALSE}
...
```{r 01-new-map, out.width= "50%", echo = FALSE}
...
```{r 01-add-folder-connection, out.width= "50%", echo = FALSE}
    knitr::include_graphics("images/01-add-folder-connection.png")
```

Navigate to where the data is saved and click ok. When you can find the data folder, drag-and-drop the **L5047026subset_19990922_7B.dat**  file into the map window. At this point, you should see an RGB satellite image of the city of Vancouver (Figure 3) if the mapview does not immediately pan to the image right click **L5047026subset_19990922_7B.dat** in the Contents pane and press Zoom to Layer.
...
```{r 01-catalog-pane, out.width= "50%", echo = FALSE}
    knitr::include_graphics("images/01-catalog-pane.png")
```


```{r 01-true-colour-composite-vancouver, out.width= "100%", echo = FALSE}
...
It is now time to explore your imagery. Right click the L5047026subset_19990922_7B.dat file in the Contents pane and select “Properties”. Use the menu on the left-hand side and select the “Source” page and the Raster Information drop down. 

```{r 01-raster-information-drop-down, out.width= "50%", echo = FALSE}
...
```{r 01-explore-tool, out.width= "50%", echo = FALSE}
...
**Displaying Greysale, True Colour, & False Colour Imagery**
...
```{r 01-grey-scale, out.width= "50%", echo = FALSE}
...
```{r 01-symbology-stretch, out.width= "50%", echo = FALSE}
...
```{r 01-band-4-nir, out.width= "100%", echo = FALSE}
...
```{r 01-true-colour-landsat-image, out.width= "100%", echo = FALSE}
...
```{r 01-false-colour-composite-pink, out.width= "100%", echo = FALSE}
...
```{r 01-standard-false-colour-composite, out.width= "100%", echo = FALSE}
...
```{r 01-create-spectral-profile, out.width= "100%", echo = FALSE}
...
```{r 01-area-of-interest-points, out.width= "60%", echo = FALSE}
...
```{r 01-profile-chart, out.width= "100%", echo = FALSE}
