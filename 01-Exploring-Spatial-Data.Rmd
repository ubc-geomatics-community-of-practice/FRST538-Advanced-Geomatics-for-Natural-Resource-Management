...
|------------------------|------------------------|------------------------|
| BC Data Catalogue | [https://catalogue.data.gov.bc.ca/](https://catalogue.data.gov.bc.ca/) | Provincial datasets: forestry, land cover, cadastral, climate, transportation, natural resources |
| City of Vancouver Open Data Portal | [https://opendata.vancouver.ca/](https://opendata.vancouver.ca/) | Municipal datasets: zoning, land use, parks, trees, utilities, transportation, planning |
| Government of Canada Geoportal | [https://geo.ca/home/](https://geo.ca/home/) | Federal datasets: topography, land cover, soils, administrative boundaries |
| Lunaris | [https://www.lunaris.ca/](https://www.lunaris.ca/) | National discovery service for research data across Canadian institutions |
| UBC Geospatial Open Data | [https://github.com/UBCGeodata/ubc-geospatial-opendata](https://github.com/UBCGeodata/ubc-geospatial-opendata) | UBC-hosted geospatial datasets, campus and research related |
| Natural Resources Canada | [https://maps.canada.ca/](https://maps.canada.ca/) | Federal geospatial data: topographic maps, forests, geology, hydrography |
| Metro Vancouver Data Portal | [https://open-data-portal-metrovancouver.hub.arcgis.com/](https://open-data-portal-metrovancouver.hub.arcgis.com/) | Regional planning: air quality, utilities, infrastructure, parks |
| Natural Earth | [https://www.naturalearthdata.com/](https://www.naturalearthdata.com/) | Global vector and raster datasets at multiple scales |
| UN FAO GeoNetwork | [https://data.apps.fao.org](https://data.apps.fao.org) | Global agriculture, land cover, and environmental datasets |
...
|------------------|------------------|------------------|------------------|
| **Shapefile** | `.shp` (+ `.dbf`, `.shx`, etc.) | Legacy, widely used, multiple files | *Add Data* , then select `.shp` |
| **GeoPackage** | `.gpkg` | Modern OGC standard, single file, may contain many layers | *Add Data* , then select `.gpkg` then choose layer |
| **File Geodatabase** | `.gdb` (folder) | ESRI native format, may contain many layers | *Add Data* , then browse into folder, select layer |
| **GeoJSON** | `.geojson` | Web-mapping format | *Add Data* , then select `.geojson` |
| **FlatGeobuf** | `.fgb` | Fast modern format | *Add Data* , then select `.fgb` |
| **KML/KMZ** | `.kml`, `.kmz` | Google Earth | *KML to Layer* , then ArcGIS Pro converts to feature classes in a geodatabase and a layer file for styling |
| **CSV with coordinates** | `.csv` | Tabular data with X/Y columns | *Add Data* , then XY Table, set fields |
