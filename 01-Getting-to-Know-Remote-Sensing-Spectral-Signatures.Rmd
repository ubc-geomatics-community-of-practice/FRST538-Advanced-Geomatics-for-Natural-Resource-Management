...
We will be working with a multispectral image of Vancouver from the Landsat 5 satellite (L5047026subset_19990922_7B.dat). The data is located in the Canvas folder for Lab 1.
...
```{r 01-spectral-reflectance-characteristics, out.width= "80%", echo = FALSE, fig.align='center'}
...
```{r 01-reflectance-characteristics-unknown-features, out.width= "80%", echo = FALSE, fig.align='center'}
...
```{r 01-true-colour-composite-vancouver, out.width= "100%", echo = FALSE, fig.align='center'}
...
In this lab, we introduced concepts of using specific ranges of the electromagnetic spectrum to understand spectral reflectance and spectral signatures. Spectral signatures are determined by the spectral properties of different materials. They can be used to obtain more information to us about a material than what we can see with visible light! We used ArcGIS Pro to analyze different types of remote sensing data and visualized various combinations of bands using true and false colour composites. We also 
....
